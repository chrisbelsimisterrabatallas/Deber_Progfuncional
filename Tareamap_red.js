 ...
 */
 ...
 //El metodo some() comprueba si al nenos un elemento del array
 //cumple con la condicion implemetada por la funcion proporcionada.

 // verificar si uno de los elementos del array es mayor a 10
const goodInput = [8,9,10,3,11,16];
...
const cadenaCarac= vectorCadenas.forEach(data =>{
    console.log(data);

})
const caracteres= vectorCadenas.some(item => {
    return item > 10;
})
//console.log("¿Los numeros son mayor a 10?: ", caracteres);
...
const vectorBooleano = [
  ...
  if(vectorBooleano.includes(True)){
    console.log("True existente");
  }else{
    console.log("True no existente");
  }
...
var vectorParrafo = [
    ...
    "But stranger Lost still is",
    "Lost Carcosa."
  ];
if(vectorParrafo.includes("Lost")){
  console.log("La palabra Lost si existe");
}else{
  console.log("La palabra Lost no existe");
} 